/*
  ...
  gengetopt --input=bench.cmdline --include-getopt 
...
const char *gengetopt_args_info_purpose = "Benchmarking of MPMHL.";

const char *gengetopt_args_info_usage = "Usage: ./bench -m mode -l locks -t threads -i iterations";
...
const char *gengetopt_args_info_help[] = {
  ...
  "  -m, --mode=STRING  Benchmark mode (lock/thread)",
  "  -l, --lock=INT     Number of locks",
  "  -t, --thread=INT   Number of threads",
  "  -i, --iter=INT     Number of iterations  (default=`100')",
    0
};
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->lock_help = gengetopt_args_info_help[3] ;
  args_info->thread_help = gengetopt_args_info_help[4] ;
...
cmdline_parser_release (struct gengetopt_args_info *args_info)
{
  ...
  free_string_field (&(args_info->lock_orig));
...
cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info)
{
  ...
  if (args_info->lock_given)
    write_into_file(outfile, "lock", args_info->lock_orig, 0);
...
cmdline_parser_required2 (struct gengetopt_args_info *args_info, const char *prog_name, const char *additional_error)
{
  ...
  if (! args_info->lock_given)
    {
      fprintf (stderr, "%s: '--lock' ('-l') option required%s\n", prog_name, (additional_error ? additional_error : ""));
      error_occurred = 1;
    }
  ...
  while (1)
    {
      ...
      c = custom_getopt_long (argc, argv, "hVm:l:t:i:", long_options, &option_index);
      ...
      switch (c)
        ...
        case 'm':	/* Benchmark mode (lock/thread).  */
        ...
        case 'l':	/* Number of locks.  */
          ...
          if (update_arg( (void *)&(args_info->lock_arg), 
               &(args_info->lock_orig), &(args_info->lock_given),
              &(local_args_info.lock_given), optarg, 0, 0, ARG_INT,
              check_ambiguity, override, 0, 0,
              "lock", 'l',
              additional_error))
            goto failure;
        ...
        case 'i':	/* Number of iterations.  */
          ...
          if (update_arg( (void *)&(args_info->iter_arg), 
              ...
              &(local_args_info.iter_given), optarg, 0, "100", ARG_INT,
              check_ambiguity, override, 0, 0,
              "iter", 'i',
              additional_error))
            goto failure;
